...
int main()
{
	...
	printf ("!!!the SUBSTARCTION operation is only possible if row and column number of both matrices are same!!!\n\n");
	...
	if (row>1&&column>1)
	{
		...
		int arr1[row][column],arr2[row][column],subarr[row][column];
